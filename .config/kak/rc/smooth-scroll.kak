# user-facing options
declare-option str-to-str-map scroll_options speed=0 interval=10 max_duration=500

declare-option str-list scroll_keys_normal <c-f> <c-b> <c-d> <c-u> <pageup> <pagedown> ( ) m M <a-semicolon> \% n <a-n> N <a-N> u U <a-u> <a-U>
declare-option str-list scroll_keys_goto g k j e .
declare-option str-list scroll_keys_object B { } p i
